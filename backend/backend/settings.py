...
SECRET_KEY = config("DJANGO_SECRET_KEY", default="django-insecure-development-key-vantage-travel")
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'databases' / config('DATABASE_NAME', default='user_data.sqlite3'),
    }
}
